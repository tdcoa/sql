...
/*{{load:{db_coa}_stg.stg_dat_cpu_summary}}
/*{{call:{db_coa}.sp_dat_cpu_summary('v2')}}
/*{vis:cpu_summary.csv}*/
SELECT
 '{siteid}' as SiteID
,theDate as LogDate
...
,max(cast(CPUFrequencyMHz as decimal(9,2))/1000.00) as CPU_GHz
...
,cast(Node_Count * CPU_per_Node * Sec_per_period /1e6 as decimal(18,2)) as Total_CPU_secM
,Idle_Used_CPU_secM+IOWait_Used_CPU_secM+OS_Used_CPU_secM+DBS_Used_CPU_secM as Actual_Total_CPU_secM
