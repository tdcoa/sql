...
FROM
    ...
    (
        ...
        FROM
            DBC.QryLogObjectsV OT
        WHERE
             --jcm
              CollectTimeStamp BETWEEN {startdate} AND {enddate}  
...
SELECT
    ...
    ,CAST(QryLog.CollectTimeStamp AS DATE) AS LogDate
...
WHERE
--jcm
    OT.CollectTimeStamp BETWEEN {startdate} AND {enddate}   
...
FROM
    DBC.QryLogV
WHERE
    CollectTimeStamp BETWEEN DATE -8 AND DATE -1
GROUP BY 3;
