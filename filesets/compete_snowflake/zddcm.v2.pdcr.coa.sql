...
/*{{save:sf--daily_query_throughput.csv}}*/
/*{{vis:sf--daily_query_throughput.csv}}*/
Select
   LogDate as "Log Date"
...
where DBName <>  '*** Total ***' -- there is a RollUp in DB_Objects
;


-- COLUMN FORMATS
/*{{save:sf--column_formats.csv}}*/
select
 '{siteid}' as Site_ID
...
/*{{save:sf--tablecount_over_1500_dml.csv}}*/
/*{{vis:sf--tablecount_over_1500_dml.csv}}*/
...
/*{{save:sf--tablecount_over_1500_dml_average.csv}}*/
Select
 '{siteid}' as Site_ID
...
/*{{save:sf--databases_most_dml_tables.csv}}*/
Select DatabaseName
...
-- FORMATTED COLUMNS
/*{{save:sf--column_format_state.csv}}*/
SELECT '{siteid}' as Site_ID
...
/*{{save:sf--data_transfer.csv}}*/
/*{{vis:sf--data_transfer.csv}}*/
...
/*{{save:sf--join_frequency_log.csv}}*/
/*{{vis:sf--join_frequency_log.csv}}*/
Select
...
/*{{save:sf--join_frequency.csv}}*/
/*{{vis:sf--join_frequency.csv}}*/
Select
 join_label || case when join_label=1 then ' Table' else ' Tables' end  as "Number of Tables" --xaxis
...
/*{{save:sf--join_frequency_horz.csv}}*/
Select
...
/*{{save:sf--tablekind_by_database.csv}}*/
select
 '{siteid}' as Site_ID
