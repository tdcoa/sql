...
def coaviz_barline_X_Yb_Yln_log(csvfile, title='', height=6, width=16, save=True):
    import numpy as np
    import pandas as pd
...
coaviz_barline_X_Yb_Yln_log('sf--join_frequency_log.csv', title='Join Frequency', height=4, width=9)
